...
# nohup bash /mnt/geminisgceph1/geminicephfs/mmsearch-luban-universal/group_semantic_video/user_williamvvli/pre_experiment/mitochondria_segmentation/code/Medical-SAM-Adapter/scripts/train_isic.sh > /mnt/geminisgceph1/geminicephfs/mmsearch-luban-universal/group_semantic_video/user_williamvvli/pre_experiment/mitochondria_segmentation/experiment_results/segmentation/test_isic.log 2>&1 &